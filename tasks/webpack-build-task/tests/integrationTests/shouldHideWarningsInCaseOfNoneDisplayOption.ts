...
export const executeTest = (done: MochaDone) => {
        const testPath = path.join(__dirname, mockRunnerDefinitions, "shouldHideWarningsInCaseOfNoneDisplayOption.js");
        ...
        const expectedContent = `{"hash":"","time":1,"version":"","assets":[],"children":[],"chunks":[],"errors":["error"]`
                + `,"warnings":["warning"],"_showErrors":false,"_showWarnings":false}`;
